...
<%--
petris :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>petris :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/petris.css" var="petrisCss"/>
    <link href="${petrisCss}" rel="stylesheet"/>
